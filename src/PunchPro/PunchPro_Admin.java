...
public class PunchPro_Admin extends PunchPro_User {
	...
	PunchPro_Admin(int user_number, String user_fullname, String user_email, String user_username, String user_password, String user_role, DatabaseConnection dbConnection) throws ClassNotFoundException {
